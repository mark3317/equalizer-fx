...
import ru.markn.equalizerfx.player.AudioPlayer;
...
public class FXMLDocumentController implements Initializable {
    ...
    private void chorusBox() {
        ...
        this.audioPlayer.setChorus(!this.audioPlayer.ChorusIsActive());
    }

    @FXML
    private void overdriveBox() {
        System.out.println("OVERDRIVE");
        this.audioPlayer.setOverdrive(!this.audioPlayer.overdriveIsActive());
    }
